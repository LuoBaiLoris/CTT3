...
if(moving=false&&place_meeting(x,y,char_player)&&!position_meeting(x+10,y+9,char_player)){
	...
	Anim_Create(char_player,"x",ANIM_TWEEN.LINEAR,0,char_player.x,x+10-char_player.x,5)
	Anim_Create(char_player,"y",ANIM_TWEEN.LINEAR,0,char_player.y,y+10-char_player.y,5)}
if(position_meeting(x+10,y+9,char_player)){
	...
	if(Input_IsHeld(INPUT.UP)&&!Input_IsHeld(INPUT.DOWN)){
		...
		moving=true
		moveable=false
		Anim_Create(char_player,"y",ANIM_TWEEN.LINEAR,0,char_player.y,-20,10)
		Anim_Create(char_player,"image_index",ANIM_TWEEN.LINEAR,0,0,2,10)
		alarm[2]=16
		alarm[3]=12}
	}
	...
	if(Input_IsHeld(INPUT.LEFT)&&!Input_IsHeld(INPUT.RIGHT)){
		...
		moving=true
		moveable=false
		Anim_Create(char_player,"x",ANIM_TWEEN.LINEAR,0,char_player.x,-20,10)
		Anim_Create(char_player,"image_index",ANIM_TWEEN.LINEAR,0,0,2,10)
		alarm[2]=16
		alarm[3]=12}
	}
