...
if(_menu==2){
	...
	Anim_Create(id,"_confirm_name_x",ANIM_TWEEN.LINEAR,0,280,-80,270);
	Anim_Create(id,"_confirm_name_y",ANIM_TWEEN.LINEAR,0,72,158,270);
	Anim_Create(id,"_confirm_name_scale",ANIM_TWEEN.LINEAR,0,2,5,270);
	_choice_confirm=0;
	with(text_typer){
		event_user(15);
	}
