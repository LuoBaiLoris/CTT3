...
if(instance_exists(inst)&&inst.enable&&inst.type=1){
	instance_destroy(inst)
	audio_play_sound(snd_ding,0,0)
	image_index=1
	Anim_Create(id,"image_index",ANIM_TWEEN.LINEAR,0,1,-1,1,30)
}
...
if(instance_exists(_inst)&&_inst.type=1){_inst.enable=false}